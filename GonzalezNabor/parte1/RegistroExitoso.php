...
<div class="container-fluid">
    ...
    <div class="text-center">
        <h2 class="texto-uno">Bienvenido</h2>
            <h2 class="texto-uno">Tu registro fue exitoso</h2>
            <h3>Haz click en la opcion Iniciar Sesion</h3>
            <h3>para acceder a las Actividades Extraescolares</h3>
