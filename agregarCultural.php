...
<head>
    ...
    <title>Registro de Actividades Culturales</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body class="pagina-registro">
    <div class="registro-container">
        <h1 class="registro-titulo">REGISTRAR ACTIVIDAD CULTURAL</h1>
        <?php if (isset($_GET['mensaje'])): ?>
            <p><?php echo htmlspecialchars($_GET['mensaje']); ?></p>
        <?php endif; ?>
        <form class="registro-formulario" action="insertCultural.php" method="post">
