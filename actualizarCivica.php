...
<head>
    ...
    <title>Modificar Actividades Civicas</title>
    <link rel="stylesheet" href="css/style.css">
</head>

<body class="paaagina-actualizar">
    <?php if (isset($_GET['mensaje'])) : ?>
        <p><?php echo htmlspecialchars($_GET['mensaje']); ?></p>
    <?php endif; ?>
    <div class="actualizar-container">
        <h1 class="actualizar-titulo">ACTUALIZAR ACTIVIDAD CIVICA</h1>
        <?php
        ...
        if (isset($_GET['id'])) {
            ...
            if ($encontrado) {
                ...
                $civicaModelo = new Orm($id, 'civica', $cnn);
                $registro = $civicaModelo->getById($id);

                if ($registro) {
        ?>
                    <form class="actualizar-formulario" action="modificarCivica.php" method="post">
