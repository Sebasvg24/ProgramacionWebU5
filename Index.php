...
<div class="jumbotron bg-image text-center py-5 mb-4" style="background-image: url('fotos/banner.avif');">
        <h1 class="mt-3 texto-uno">¡Bienvenido al registro de nuestras actividad extraescolares!</h1>
        <h2 class="mt-3 texto-dos">Inscribete a alguna de nuestras actividades</h2>
        <h2 class="mt-3 texto-dos">y libera un credito complementario</h2>

        <h1 class="mt-3 texto-uno">Si no tienes una cuenta Registrate</h1>
        <h2 class="mt-3 texto-uno">en el menu de arriba</h2>
    </div>
